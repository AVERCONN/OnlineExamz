...
<script src=".\js\windows-1.js" type="text/javascript"></script>
...
<a href="login.jsp" class="log">登录</a>
...
<div class="case">
    ...
    <div class="product-wrap">
     <!--案例1-->
      ...
      <div id="massage_box" style="margin-left:300px;position:absolute;top:70px"><div class="massage">
<div class="header-1" onmousedown=MDown(massage_box)>
...
<span style="margin-left:50px;position:absolute;top:70px" >还没登录，请登录</span></div></div>
<div id="mask"></div>
        <ul class="cf">
          <li class="ml0">
            ...
            <input name="btn" type="button" class="text-1" value="马上做题" /></span>
          </li>
          <li>
          <p class="mt10"> <a href="#" target="_blank"><img src=".\images\paper_blank.png">2015年一级建造师市政公用工程考试真题&nbsp;2015-12-0</a></p>
             <span onClick="mask.style.visibility='visible';massage_box.style.visibility='visible'" style="cursor:hand">
             <input name="btn" type="button" class="text-2"  value="马上做题" /></span>
          </li>
          <li>
          <p class="mt10"> <a href="#" target="_blank"><img src=".\images\paper_blank.png">城市规划师考试《城市规划管理与法规》真题2009年&nbsp;2015-12-08</a></p>
             <span onClick="mask.style.visibility='visible';massage_box.style.visibility='visible'" style="cursor:hand">
             <input name="btn" type="button" class="text-3" value="马上做题" /></span>
          </li>
          <li>
         <p class="mt10"> <a href="#" target="_blank"><img src=".\images\paper_blank.png">2015年安全生产技术真题&nbsp;2015-12-07</a></p>
             <span onClick="mask.style.visibility='visible';massage_box.style.visibility='visible'" style="cursor:hand">
             <input name="btn" type="button" class="text-4" value="马上做题" /></span>
          </li>
		   <li>
         <p class="mt10"> <a href="#" target="_blank"><img src=".\images\paper_blank.png">2015年安全生产管理知识真题&nbsp;2015-12-07</a></p>
             <span onClick="mask.style.visibility='visible';massage_box.style.visibility='visible'" style="cursor:hand">
             <input name="btn" type="button" class="text-5" value="马上做题" /></span>
          </li>
        </ul>
      </div>
      <!--案例2-->
      <div class="product">
       <div id="massage_box_2" style="margin-left:300px;position:absolute;top:70px"><div class="massage_2">
<div class="header-1" onmousedown=MDown(massage_box)>
<span onClick="massage_box_2.style.visibility='hidden'; mask_2.style.visibility='hidden'" style="float:right; display:inline;cursor:hand">×</span></div>
<span style="margin-left:50px;position:absolute;top:70px" >还没登录，请登录</span></div></div>
<div id="mask_2"></div>
        <ul class="cf">
          <li class="ml0">
          <p class="mt10"> <a href="#" target="_blank"><img src=".\images\paper_blank.png">2015年执业药师《药学综合知识》真题及答案&nbsp;2016-1-06</a></p>
             <span onClick="mask_2.style.visibility='visible';massage_box_2.style.visibility='visible'" style="cursor:hand">
             <input name="btn" type="button" class="text-1" value="马上做题" /></span>
          </li>
          <li>
      ...
      <!--案例3-->
      <div class="product">
      <div id="massage_box_3" style="margin-left:300px;position:absolute;top:70px"><div class="massage_3">
<div class="header-1" onmousedown=MDown(massage_box)>
<span onClick="massage_box_3.style.visibility='hidden'; mask_3.style.visibility='hidden'" style="float:right; display:inline;cursor:hand">×</span></div>
<span style="margin-left:50px;position:absolute;top:70px" >还没登录，请登录</span></div></div>
<div id="mask_3"></div>
        <ul class="cf">
          <li class="ml0">
           <p class="mt10"> <a href="#" target="_blank"><img src=".\images\paper_blank.png">江苏省2015年普通高校专转本选拔考试试题&nbsp;2015-12-30</a></p>
             <span onClick="mask_3.style.visibility='visible';massage_box_3.style.visibility='visible'" style="cursor:hand">
             <input name="btn" type="button" class="text-1" value="马上做题" /></span>
          </li>
          <li>
      ...
      <!--案例4-->
      <div class="product">
      <div id="massage_box_4" style="margin-left:300px;position:absolute;top:70px"><div class="massage_4">
<div class="header-1" onmousedown=MDown(massage_box)>
<span onClick="massage_box_4.style.visibility='hidden'; mask_4.style.visibility='hidden'" style="float:right; display:inline;cursor:hand">×</span></div>
<span style="margin-left:50px;position:absolute;top:70px" >还没登录，请登录</span></div></div>
<div id="mask_4"></div>
        <ul class="cf">
          <li class="ml0">
           <p class="mt10"> <a href="#" target="_blank"><img src=".\images\paper_blank.png">linux模拟试卷&nbsp;2015-11-28</a></p>
             <span onClick="mask_4.style.visibility='visible';massage_box_4.style.visibility='visible'" style="cursor:hand">
             <input name="btn" type="button" class="text-1" value="马上做题" /></span>
          </li>
          <li>
          <p class="mt10"> <a href="#" target="_blank"><img src=".\images\paper_blank.png">计算机网络期末试卷&nbsp;2015-11-24</a></p>
             <span onClick="mask_4.style.visibility='visible';massage_box_4.style.visibility='visible'" style="cursor:hand">
             <input name="btn" type="button" class="text-2" value="马上做题" /></span>
          </li>
          <li>
...
<div class="case">
    ...
    <div class="product-wrap">
     <!--案例1-->
      <div class="product show">
      <div id="massage_box_1" style="margin-left:300px;position:absolute;top:70px"><div class="massage_1">
<div class="header-2" onmousedown=MDown(massage_box_1)>
<span onClick="massage_box_1.style.visibility='hidden'; mask_1.style.visibility='hidden'" style="float:right; display:inline;cursor:hand">×</span></div>
<span style="margin-left:50px;position:absolute;top:70px" >还没登录，请登录</span></div></div>
<div id="mask_1"></div>
        <ul class="cf">
          <li class="ml0">
            <p class="mt10"> <a href="#" target="_blank"><img src=".\images\paper_blank.png">专业英语四级真题2015年&nbsp;2015-5-05</a></p>
            <span onClick="mask_1.style.visibility='visible';massage_box_1.style.visibility='visible'" style="cursor:hand">
            <input name="btn" type="button" class="text-1" value="马上做题" /></span>
          </li>
          <li>
      ...
      <!--案例2-->
      <div class="product">
      <div id="massage_box_5" style="margin-left:300px;position:absolute;top:70px"><div class="massage_5">
<div class="header-2" onmousedown=MDown(massage_box_1)>
<span onClick="massage_box_5.style.visibility='hidden'; mask_5.style.visibility='hidden'" style="float:right; display:inline;cursor:hand">×</span></div>
<span style="margin-left:50px;position:absolute;top:70px" >还没登录，请登录</span></div></div>
<div id="mask_5"></div>
        <ul class="cf">
          <li class="ml0">
          <p class="mt10"> <a href="#" target="_blank"><img src=".\images\paper_blank.png">经济师考试初级经济基础真题&nbsp;2016-1-06</a></p>
            <span onClick="mask_5.style.visibility='visible';massage_box_5.style.visibility='visible'" style="cursor:hand">
            <input name="btn" type="button" class="text-1" value="马上做题" /></span>
          </li>
          <li>
      ...
      <!--案例3-->
      <div class="product">
       <div id="massage_box_6" style="margin-left:300px;position:absolute;top:70px"><div class="massage_6">
<div class="header-2" onmousedown=MDown(massage_box_1)>
<span onClick="massage_box_6.style.visibility='hidden'; mask_6.style.visibility='hidden'" style="float:right; display:inline;cursor:hand">×</span></div>
<span style="margin-left:50px;position:absolute;top:70px" >还没登录，请登录</span></div></div>
<div id="mask_6"></div>
        <ul class="cf">
          <li class="ml0">
           <p class="mt10"> <a href="#" target="_blank"><img src=".\images\paper_blank.png">国际货运代理考试业务卷真题&nbsp;2015-12-30</a></p>
            <span onClick="mask_6.style.visibility='visible';massage_box_6.style.visibility='visible'" style="cursor:hand">
            <input name="btn" type="button" class="text-1" value="马上做题" /></span>
          </li>
          <li>
      ...
      <!--案例4-->
      <div class="product">
      <div id="massage_box_7" style="margin-left:300px;position:absolute;top:70px"><div class="massage_7">
<div class="header-2" onmousedown=MDown(massage_box_1)>
<span onClick="massage_box_7.style.visibility='hidden'; mask_7.style.visibility='hidden'" style="float:right; display:inline;cursor:hand">×</span></div>
<span style="margin-left:50px;position:absolute;top:70px" >还没登录，请登录</span></div></div>
<div id="mask_7"></div>
        <ul class="cf">
          <li class="ml0">
           <p class="mt10"> <a href="#" target="_blank"><img src=".\images\paper_blank.png">律师考试冲刺试卷（七）&nbsp;2015-11-28</a></p>
            <span onClick="mask_7.style.visibility='visible';massage_box_7.style.visibility='visible'" style="cursor:hand">
            <input name="btn" type="button" class="text-1" value="马上做题" /></span>
          </li>
          <li>
...
window.onload=function(){
	var oBtn=document.getElementByld('btn1');
