...
<span style="margin-left:50px;position:absolute;top:70px" >你已被拉入黑名单！</span></div></div>
<div id="mask"></div>
      
        <ul class="cf">
          <li class="ml0">
            <p class="mt10"> <a href="#" target="_blank" 
            ><img src=".\images\paper_blank.png">土木工程期末A卷&nbsp;2015-12-17</a></p>
             <span onClick="mask.style.visibility='visible';massage_box.style.visibility='visible'" style="cursor:hand">
