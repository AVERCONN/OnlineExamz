...
<div id="mask"></div>
        ...
        <ul class="cf">
          <li class="ml0">
            <p class="mt10"> <a href="http://localhost:8080/OnlineExam/ExamPage.jsp?pNo=construction0001" target="_blank" 
            ><img src=".\images\paper_blank.png">土木工程期末A卷&nbsp;2015-12-17</a></p>
            <a href="http://localhost:8080/OnlineExam/ExamPage.jsp?pNo=construction0001" target="_blank"
              > <input name="btn" type="button" class="text-1" value="马上做题" /></a>
          </li>
          <li>
      ...
      <div class="product">
        <ul class="cf">
          ...
          <li>
          <p class="mt10"> <a href="http://localhost:8080/OnlineExam/ExamPage.jsp" target="_blank"><img src=".\images\paper_blank.png">计算机网络期末试卷&nbsp;2015-11-24</a></p>
           <a href="http://localhost:8080/OnlineExam/ExamPage.jsp?pNo=computer0003" target="_blank"
             > <input name="btn" type="button" class="text-2" value="马上做题" /></a>
          </li>
          <li>
