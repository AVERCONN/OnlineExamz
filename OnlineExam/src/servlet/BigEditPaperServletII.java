...
/**
 * Servlet implementation class BigEditPaperServletII
 */
public class BigEditPaperServletII extends HttpServlet {               //大幅度修改试卷功能中编辑试题界面
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BigEditPaperServletII() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print(pname+"<br>");
		out.print("一、选择题<br>");
		out.print("<form name='form1' action='BigEditPaperServletIII' method='post'>");
		for(int i=0;i<_pChoShu;i++) {          //遍历输出
			if(paperDao.getChoiceQuestions(pname)[i]!=null) {
				...
				out.print((i+1)+"、<input type='text' name='pcq"+i+"' /><br>");
