...
/**
 * Servlet implementation class PaperSelectII
 */
public class PaperSelectII extends HttpServlet {               //编辑试卷功能中的试卷筛选功能
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PaperSelectII() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<html>");
		out.print("<head><title>编辑试卷</title>");
		...
		out.print("<body>");
		out.print("试卷类别筛选：");
		out.print("<form action='PaperSelectII' method='post'>");
