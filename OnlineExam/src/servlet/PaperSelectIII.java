...
/**
 * Servlet implementation class PaperSelectIII
 */
public class PaperSelectIII extends HttpServlet {               //删除试卷功能中的试卷筛选功能
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PaperSelectIII() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("function check() {");
		out.print("if(confirm(\"是否确认删除选中试卷？\")) {document.form1.submit();}");
		out.print("}");
		out.print("</script>");
		...
		out.print("<input type='button' value='确定' onclick=\"check()'\" /><br>");
